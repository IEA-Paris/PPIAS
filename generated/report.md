...
missingReferences:
  ...
  7_Ogien:
    - >-
      ...
      écrire un livre qui n'a jamais vu le jour à la suite d'une violente
      dispute entre les deux co-auteurs (García Sanchez, 2020)
    - (Garkinkel et Sacks, 1970)
  8_Pereyra:
    - (Cicourel, cited in Kornblit, 2012
    - (cited in Kornblit, 2012
  FP2_Kothari:
    - '@palamenghi2020a'
  FP_Starominski:
  ...
  artificial-consciousness-science-fiction-utopia-or-pandora-s-box:
    - (Evers & Changeux, 2016)
    - (Evers & Farisco, 2026)
    - (see e.g., Verschure, 2016)
    - (see e.g., Pennartz et al., 2019)
    - (cf. also Farisco et al., 2026)
  ...
  beyond-the-illusion-of-change-bridging-the-classroom-and-the-workplace-via-processes-of-temporal-re-contextualisation:
    ...
    - '@lse'
    - '@liberare'
  can-healthcare-be-humanized-the-twin-challenges-of-clinician-engagement-and-patient-empowerment-in-a-complex-system:
  ...
  climate-assemblies-and-the-law-a-research-roadmap:
    ...
    - (IASS, 2021)
    - >-
      (for instance, 'changing food, farming and land use' -- Climate Assembly
      UK, 2021
    - (Brown & Taylor, 2015)
  ...
  hamlets-commons-communes-and-charity-in-the-western-alps-biella-and-ossola-16th-19th-centuries:
    ...
    - >-
      . This process began with a division of the valley into two parts, with
    ...
    - >-
      ...
      storico-territoriale dei comuni piemontesi, 1994
    - Koeln, 1693)
    - AST, Corte, Gran Carta de Stati di terraferma di S.M., 1852
    - >-
      A long sequel of petitions and appeals in AST, Corte, Paesi per A e B,
      Lettera V, m. 38, nn. 21, 22, 1819
    - >-
    ...
    - >-
      ...
      n. 4, 1787
    - >-
      E. Corniolo, "Nascita e gestione di una risorsa collettiva. L'Alpe di
    ...
    - >-
      Ibidem, m. 15: Atto di divisione fra Campiglia, San Paolo, Quittengo e
      Piedicavallo, 1728
    - >-
      ASCP, m. 33: "Appello di Rosazza per tenere consiglio in questa borgata",
      1701
    - >-
      ASCP, m.33, Rosazza's plea for the renewal of the Piedicavallo Council on
      a basis proportional to the weight of the hamlets and rotation between
      them, 1734
    - Ibidem, 1765
    - >-
      Archivio Storico del Comune di Rosazza, not inventoried, 'Congregazione di
      Carità ed Ente Comunale di Assistenza, 1908
    - >-
      (ASCG, b. 2, Pergamene 18-21, Convention and transaction between Germagno
      and Gattugno for territory boundaries, 17/4/1534
    - >-
  ...
  inalienability-as-reciprocity-an-essay-on-kinship:
    ...
    - >-
      ...
      interpreters and translators, see Hēnare, 2018
    - as inalienability, see Glasser, 2020
    - in the modern Lebanese context, see Moumtaz, 2021
    - On the oral text that resides in an object, see Barber, 2007
  indigenous-languages-as-commons-for-environmental-governance:
    - (Rodrigues Barreto et al., 2025)
    - (Hess & Ostrom, 2007)
  ...
  kinds-of-we-plural-subjects-in-a-polynesian-language:
    ...
    - >-
      Even though the inclusive "we" outnumbers the exclusive "we" almost four
      times, the number of exclusive "we" in the April 7, 1979
  netboards:
    - >-
      Here is our experience, mainly based on the netboards of WPRN, The
  ...
  paths-to-recognition-through-politics-in-the-2024-presidential-election-among-young-workers-living-in-and-around-manchester-new-hampshire:
    ...
    - (e.g., Hillhorst, 2024)
    - (Hillhorst, 2024
    - (e.g., González-Rostani, 2025)
    - (e.g., Lipset & Marks, 2001)
    - >-
      An early version of this paper was presented at the Eastern Sociological
      Society meetings, March 9, 2025
  ...
  residues-that-matter-why-innovation-societies-need-to-rethink-their-response-ability:
    - >-
      (for a critical discussion of these devlopments see Henrekson et al.,
      2024)
  ...
  the-power-of-moral-conviction-how-it-catalyzes-dogmatism-intolerance-and-violence:
    ...
    - (Tomala & Rucker, 2015)
    - (Ugazio et al., 2021)
    - (Mazancieux et al., 2023
    - Ferguson, 2021)
    - Osborne et al., 2023)
    - (Luttrell et al., 2019, Ryan, 2019)
    - (Luttrell et al., 2016)
    - (Falk & Scholtz, 2018)
    - (Bastian et al., 2015)
    - (Boutyline & Willer, 2016)
    - (Costello et al., 2021)
  ...
  the-re-doing-of-the-i-face-bond-bodies-prostheses-and-affordances:
    ...
    - (Gallese & Cuccio, 2015)
    - (Bréedart et al., 2006
  the-site-syndrome-produces-classroom-blind-technologies:
    - (Slater et al., 2011)
    - Strauss & Rummel, 2020
  understanding-the-software-of-the-mind-self-and-culture-analysis-of-the-secrets-to-happiness-health-and-long-life:
    - (Toth & Schlick, 2007)
    - (Toth and Schlick, 2007)
    - >-
      (i.e., the forced sterilization, segregation people based on gender and
      race, and restriction of immigration (Chorover, 1980)
    - Kim & Chun, 1984)
    - (Kim & Chun, 1984)
    - Kim & Chun, 1984
    - (Kim & Yamaguchi, 2005
    ...
    - (Bandura, 1977
    - (Kim et al., 2003)
    - (e.g., health, education, happiness, and well-being (Gewirth, 1982)
    - (Kim, 2003)
    - (Kim & Park, 2005, 2008)
    - (Feinberg, 1983)
    - (Deloitte, 2021
