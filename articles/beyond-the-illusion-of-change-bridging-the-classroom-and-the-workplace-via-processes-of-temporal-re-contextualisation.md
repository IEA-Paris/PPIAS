...
**Citation**: Rogers, B. M. (2025).Beyond the illusion of change: bridging the 'classroom' and the workplace via processes of temporal re-contextualisation.  In *Proceedings of the Paris Institute for Advanced Study* (Vol. X). https://doi.org/xxx
...
**The complexity of context -- creating the *successful* *illusion* of change **
...
**The dark shadow of Transfer - exposing the roots of the problem**
...
**Implementation *in the wild* - no plan survives first contact with *temporality***
...
![](blob:https://euangoddard.github.io/c4adc9d7-28fe-4b3d-bb17-3c1d091bdfd4)
...
**Contact details: **Please feel free to contact Barry Rogers by email at either <b.m.rogers@lse.ac.uk> or <barry@liberare.com>    
