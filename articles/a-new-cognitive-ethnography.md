...
*The bearing recorder first proposes two landmarks. He leans over the chart (saying, "It'll be ...") and uses his left index finger to quickly trace a line from a landmark called Ballast Point to the approximate location of the EP (saying "that"). His finger wavers for a moment, making a loose clockwise loop over the chart, then he traces a line from the landmark called Bravo Wharf (saying " 'n that"). BR's left hand remains in the vicinity of the EP, and he pauses for one second.* (This moment is shown in Figure 5.4.3). 

![A group of people working on a map

Description automatically generated](blob:https://euangoddard.github.io/18358ad8-3936-4303-990f-44ca2cd16fbd)
